<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" CodeBehind="DealerItemTransaction.aspx.cs" Inherits="SUL.SCM.DealerItemTransaction" %>
        ...
        <div class="innerAll">
            <div class="row">
                ...
                <div class="widget widget-inverse">
                    ...
                    <asp:Label runat="server" Visible="False" ID="lblsearchBtn"></asp:Label>
                    <div class="widget-body">
                        <div class="row">
                            <telerik:RadGrid ID="RadGridDealerTransaction" runat="server" AutoGenerateColumns="False" CellSpacing="0" AllowPaging="True"
                                             OnPageIndexChanged="RadGridDealerTransaction_OnPageIndexChanged" OnPageSizeChanged="RadGridDealerTransaction_OnPageSizeChanged"
                                             Skin="Metro" Width="100%" GridLines="None" OnItemCommand="RadGridDealerTransaction_OnItemCommand" ShowFooter="True">
                                ...
                                <MasterTableView>
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="InvoiceDate" FilterControlAltText="Filter column column" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-HorizontalAlign="Left" HeaderText="Invoice Date" UniqueName="colInvoiceDate" Visible="true">
                                            <ColumnValidationSettings>
                                                <ModelErrorMessage Text=""></ModelErrorMessage>
                                            </ColumnValidationSettings>
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="ItemTotal" FilterControlAltText="Filter column column" ItemStyle-HorizontalAlign="Left"
                                                                 HeaderText="Item Total" UniqueName="colItemTotal" Visible="True" Aggregate="Sum" FooterText="Item Total : " ReadOnly="True" DataType="System.Decimal">
                                            <ColumnValidationSettings>
                                                <ModelErrorMessage Text=""></ModelErrorMessage>
                                            </ColumnValidationSettings>
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="Discount" FilterControlAltText="Filter column column" ItemStyle-HorizontalAlign="Left"
                                                                 HeaderText="Discount" UniqueName="colDiscount" Visible="True" Aggregate="Sum" FooterText="Discount: " ReadOnly="True" DataType="System.Decimal">
                                            <ColumnValidationSettings>
                                                <ModelErrorMessage Text=""></ModelErrorMessage>
                                            </ColumnValidationSettings>
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="Total" FilterControlAltText="Filter column column" ItemStyle-HorizontalAlign="Left"
                                                                 HeaderText="Total" UniqueName="colTotal" Visible="True" Aggregate="Sum" FooterText="Total: " ReadOnly="True" DataType="System.Decimal">
                                            <ColumnValidationSettings>
                                                <ModelErrorMessage Text=""></ModelErrorMessage>
                                            </ColumnValidationSettings>
                                        </telerik:GridBoundColumn>
