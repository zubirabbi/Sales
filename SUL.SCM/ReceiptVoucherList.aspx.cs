...
namespace SUL.SCM
{
    ...
    public partial class ReceiptVoucherList : System.Web.UI.Page
    {
        ...
        private void LoadReceiptVoucher()
        {
            try
            {
                string condition = string.Empty;
                dtReceiptVoucher = new Payment().GetAllViewpayment(condition);

                RadGridReceiptVoucher.DataSource = dtReceiptVoucher;
                RadGridReceiptVoucher.DataBind();
        ...
        {
            DataTable dt = dtReceiptVoucher.Copy();

            string attachment = "attachment; filename=Receipt.xls";
        ...
        protected void RadGridReceiptVoucher_PageIndexChanged(object sender, GridPageChangedEventArgs e)
        {

        }

        protected void RadGridReceiptVoucher_PageSizeChanged(object sender, GridPageSizeChangedEventArgs e)
        {

        }

        protected void RadGridReceiptVoucher_ItemCommand(object sender, GridCommandEventArgs e)
        {
