<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" CodeBehind="ReceivingInfoList.aspx.cs" Inherits="SUL.SCM.ReceiveingInfoList" %>
            ...
            <div class="row">
                <div class="widget widget-inverse">
                    <div class="widget-head">
                        <h3 class="heading">Receiving List</h3>
                    </div>
                    <div class="widget-body">
                        <div class="row">
                            <telerik:RadGrid ID="RadGridReceiverMaster" runat="server" AutoGenerateColumns="False" CellSpacing="0" AllowPaging="True" OnPageIndexChanged="RadGridReceiverMaster_OnPageIndexChanged" OnPageSizeChanged="RadGridReceiverMaster_OnPageSizeChanged" Skin="Metro" Width="100%" GridLines="None" OnItemCommand="RadGridReceiverMaster_OnItemCommand">
                                ...
                                <MasterTableView>
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="IsInvoiceCreated" HeaderText="Status" ItemStyle-HorizontalAlign="Left" AllowFiltering="False" HeaderStyle-Width="100px" ColumnEditorID="GridTextBoxEditor" UniqueName="colIsInvoiceCreated" Display="true">
                                            <ColumnValidationSettings>
                                                <ModelErrorMessage Text=""></ModelErrorMessage>
                                            </ColumnValidationSettings>
