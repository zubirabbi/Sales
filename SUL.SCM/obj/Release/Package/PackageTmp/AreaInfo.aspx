<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" CodeBehind="AreaInfo.aspx.cs" Inherits="SUL.SCM.AreaInfo" %>
            ...
            <div class="row">
                <div class="widget widget-inverse">
                    <div class="widget-head">
                        <h3 class="heading">Area Information </h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <telerik:RadComboBox ID="rdropRegion" runat="server" AutoPostBack="True" OnDataBound="rdropRegion_OnDataBound" OnSelectedIndexChanged="rdropRegion_OnSelectedIndexChanged" Skin="Metro" Width="220px" Font-Names="" AllowCustomText="True" DropDownWidth="300px" Filter="Contains" MarkFirstMatch="True">
                                        </telerik:RadComboBox>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-4 control-label" style="padding-top: 7px; text-align: right;">Area Code</label>
                                    <div class="col-md-8">
                                        <telerik:RadTextBox ID="rtxtAreaCode" CssClass="form-control" Skin="Metro" Width="220px" runat="server" Height="35px" Enabled="True" ViewStateMode="Enabled"></telerik:RadTextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-4 control-label" style="padding-top: 7px; text-align: right;">Area Name</label>
                                    <div class="col-md-8">
                                        <telerik:RadTextBox ID="rtxtAreaName" CssClass="form-control" Skin="Metro" Width="220px" runat="server" Height="35px" ViewStateMode="Enabled"></telerik:RadTextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <telerik:RadTextBox ID="rtxtDesc" CssClass="form-control" Skin="Metro" Width="220px" runat="server" Height="35px" ViewStateMode="Enabled"></telerik:RadTextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="clearfix"></div>
