<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" CodeBehind="ProductCategoryInfo.aspx.cs" Inherits="SUL.SCM.ProductCategoryInfo" %>
        ...
        <div class="innerAll">
            <div class="row">
                ...
                <div class="widget widget-inverse">
                    ...
                    <div class="widget-body">
                        <div class="row">
                            <telerik:RadGrid ID="RadGridProductCate" runat="server" AutoGenerateColumns="False" CellSpacing="0" AllowPaging="True" OnPageIndexChanged="RadGridProductCate_OnPageIndexChanged" OnPageSizeChanged="RadGridProductCate_OnPageSizeChanged" Skin="Metro" Width="100%" GridLines="None" OnItemCommand="RadGridProductCate_OnItemCommand">
                                ...
                                <MasterTableView>
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="CategoryDescription" FilterControlAltText="Filter column column" ItemStyle-HorizontalAlign="Left" HeaderText="Category Description" UniqueName="colCategoryDescription" Visible="true">
                                            <ColumnValidationSettings>
                                                <ModelErrorMessage Text=""></ModelErrorMessage>
                                            </ColumnValidationSettings>
                                        </telerik:GridBoundColumn>
