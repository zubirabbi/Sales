<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" CodeBehind="ReceiveingInfo.aspx.cs" Inherits="SUL.SCM.ReceiveingInfo" %>
...
<div class="widget-head">
    <h3 class="heading">Product Receiveing</h3>
</div>
...
<div class="widget widget-inverse">
    ...
    <div class="widget-body">
        <div class="row">
            ...
            <asp:Label ID="lblIncoiceCreate" runat="server" Visible="False"></asp:Label>
                ...
                <MasterTableView>
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="color" FilterControlAltText="Filter column column" ItemStyle-HorizontalAlign="Left" HeaderText="color" UniqueName="colcolor" Display="False">
                         ...
                         <telerik:GridBoundColumn DataField="colorName" FilterControlAltText="Filter column column" ItemStyle-HorizontalAlign="Left" HeaderText="color" UniqueName="colcolorName">
                            <ColumnValidationSettings>
                                <ModelErrorMessage Text=""></ModelErrorMessage>
                            </ColumnValidationSettings>
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="ProductUnit" FilterControlAltText="Filter column column" ItemStyle-HorizontalAlign="Left" HeaderText="Unit" UniqueName="colUnit" Display="False">
                            <ColumnValidationSettings>
                                <ModelErrorMessage Text=""></ModelErrorMessage>
                            </ColumnValidationSettings>
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="ProductUnitName" FilterControlAltText="Filter column column" ItemStyle-HorizontalAlign="Left" HeaderText="Unit" UniqueName="colUnitname">
                            <ColumnValidationSettings>
                                <ModelErrorMessage Text=""></ModelErrorMessage>
                            </ColumnValidationSettings>
                        </telerik:GridBoundColumn>
...
<div class="row">
    <div class="col-md-6 pull-left">
        ...
        <div style="float: left; height: 3px; width: 10px;"></div>
        <asp:Button ID="btnApprove" runat="server" OnClick="btnApprove_OnClick" Text="Approve" Visible="False" CssClass="btn btn-warning pull-left"/>
    </div>
